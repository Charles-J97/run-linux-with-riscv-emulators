...
```
NOTICE THAT: The way above to set the `PATH` and `RISCV` is temporary. Every time you start your Ubuntu, you need to set them again. There are ways to set them permanently online. You can google them.
